...
closedData :any = ELEMENT_DATA.filter((val) => {
 ...
 closedDataCount : number = this.closedData.length
  ...
  cards = [
    { icon: 'hourglass-half', value1: this.pendingDataCount, value2: 'Pending', bgColor: 'white' },
    { icon: 'thumbs-up', value1: this.resolvedDataCount, value2: 'Resolved', bgColor: 'white' },
    { icon: 'check-circle', value1: this.closedDataCount, value2: 'Closed', bgColor: 'white' },
    { icon: 'users', value1: this.allDataCount, value2: 'Total Request', bgColor: 'white' }
  ];
