...
console.log('Program has started'); // //stored in the first phase of the event loop
...
fs.readFile('./assetTextFiles/input.txt', function () {
  console.log('File read complete'); //first phase
...
console.log('Program has finished'); //microtask queue and nextTick queue
